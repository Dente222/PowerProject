...
public class ItemInit {
	...
	//Items Register
	public static final Item INGOT_MALACHITE = new ItemBase("ingot_malachite");
	
	
	//Tools Register
	public static final Item PICKAXE_MALACHITE = new ToolPickaxe("pickaxe_malachite", TOOL_MALACHITE);
	public static final Item AXE_MALACHITE = new ToolAxe("axe_malachite", TOOL_MALACHITE);
	public static final Item SHOVEL_MALACHITE = new ToolShovel("shovel_malachite", TOOL_MALACHITE);
	public static final Item SWORD_MALACHITE = new ToolSword("sword_malachite", TOOL_MALACHITE);
	public static final Item HOE_MALACHITE = new ToolHoe("hoe_malachite", TOOL_MALACHITE);
